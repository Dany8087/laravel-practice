                                ...
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    @csrf
                                        ...
                                        <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                            <button type="submit" id="login" class="btn btn-default btn-lg">Login</button>
                                            <button type="button" class="btn btn-default btn-lg"> <a href="registration">Register</a></button>
                                        </div>
